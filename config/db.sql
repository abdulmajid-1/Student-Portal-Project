...
-- -- 2. Add the foreign key constraint referencing users(U_id)
-- ALTER TABLE teachers
...
-- ALTER TABLE attendance DROP FOREIGN KEY attendance_ibfk_2; -- for course_id
-- ALTER TABLE attendance DROP FOREIGN KEY attendance_ibfk_3; -- for teacher_id
